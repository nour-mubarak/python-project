...
Supports OpenAI, Anthropic (Claude), and Azure OpenAI.
"""
...
class ModelRunner:
    ...
    def _query_anthropic(self, model_config, prompt: str, system_prompt: str = "") -> dict:
    ...
    def run_evaluation(self, prompts: List[dict], model_configs: list,
                       system_prompt: str = "", runs_per_prompt: int = 1,
                       progress_callback=None) -> List[ModelResponse]:
        """
            ...
            for model_config in model_configs:
                for lang in ["en", "ar"]:
                    ...
                    for run_idx in range(runs_per_prompt):
                        ...
                        result = self.query_model(model_config, prompt_text, system_prompt)
